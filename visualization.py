...
odi_rankings = pd.read_csv(r'C:\Users\Maroof\Desktop\Project 1 (1)\ICC_ODI_Rankings.csv')
t20i_rankings = pd.read_csv(r'C:\Users\Maroof\Desktop\Project 1 (1)\ICC_WT20I_Rankings.csv')
test_rankings = pd.read_csv(r'C:\Users\Maroof\Desktop\Project 1 (1)\ICC_Test_Rankings.csv')
wodi_rankings = pd.read_csv(r'C:\Users\Maroof\Desktop\Project 1 (1)\ICC_WODI_Rankings.csv')
t20_rankings=pd.read_csv(r'C:\Users\Maroof\Desktop\Project 1 (1)\ICC_T20I_Rankings.csv')

odi_all_round = pd.read_csv(r'C:\Users\Maroof\Desktop\Project 1 (1)\Players Ranking\odi_all-rounder.csv')
odi_bat = pd.read_csv(r'C:\Users\Maroof\Desktop\Project 1 (1)\Players Ranking\odi_batting.csv')
odi_bowl = pd.read_csv(r'C:\Users\Maroof\Desktop\Project 1 (1)\Players Ranking\odi_bowling.csv')
t20_all_round = pd.read_csv(r'C:\Users\Maroof\Desktop\Project 1 (1)\Players Ranking\t20_all-rounder.csv')
t20_bat = pd.read_csv(r'C:\Users\Maroof\Desktop\Project 1 (1)\Players Ranking\t20_batting.csv')
t20_bowl = pd.read_csv(r'C:\Users\Maroof\Desktop\Project 1 (1)\Players Ranking\t20_bowling.csv')
test_all_round=pd.read_csv(r'C:\Users\Maroof\Desktop\Project 1 (1)\Players Ranking\test_all-rounder.csv')
test_bat=pd.read_csv(r'C:\Users\Maroof\Desktop\Project 1 (1)\Players Ranking\test_batting.csv')
test_bowl=pd.read_csv(r'C:\Users\Maroof\Desktop\Project 1 (1)\Players Ranking\test_bowling.csv')
Wodi_all_round=pd.read_csv(r'C:\Users\Maroof\Desktop\Project 1 (1)\Players Ranking\womenodi_all-rounder.csv')
Wodi_bat=pd.read_csv(r'C:\Users\Maroof\Desktop\Project 1 (1)\Players Ranking\womenodi_batting.csv')
Wodi_bowl=pd.read_csv(r'C:\Users\Maroof\Desktop\Project 1 (1)\Players Ranking\womenodi_bowling.csv')
Wt20_all_rounnd=pd.read_csv(r'C:\Users\Maroof\Desktop\Project 1 (1)\Players Ranking\woment20_all-rounder.csv')
Wt20_bat=pd.read_csv(r'C:\Users\Maroof\Desktop\Project 1 (1)\Players Ranking\woment20_batting.csv')
Wt20_bowl=pd.read_csv(r'C:\Users\Maroof\Desktop\Project 1 (1)\Players Ranking\woment20_bowling.csv')
...
def display_players():
    # Load the CSV file
    data = pd.read_csv(r'C:\Users\Maroof\Desktop\Project 1 (1)\extracted_names.csv')
...
def display_overview_row(row_name='overview'):
    ...
    # Load the CSV file
    name = player_name
    folder_path = r"C:\Users\Maroof\Desktop\Project 1 (1)\Individual Players"
...
def player_bio():
    # List of file paths
    file_paths = [
        r'C:\Users\Maroof\Desktop\Project 1 (1)\10 Players Bio\Afghanistan_Cricketers.csv',
        r'C:\Users\Maroof\Desktop\Project 1 (1)\10 Players Bio\Australia_Cricketers.csv',
        r'C:\Users\Maroof\Desktop\Project 1 (1)\10 Players Bio\Bangladesh_Cricketers.csv',
        r'C:\Users\Maroof\Desktop\Project 1 (1)\10 Players Bio\England_Cricketers.csv',
        r'C:\Users\Maroof\Desktop\Project 1 (1)\10 Players Bio\India_Cricketers.csv',
        r'C:\Users\Maroof\Desktop\Project 1 (1)\10 Players Bio\Ireland_Cricketers.csv',
        r'C:\Users\Maroof\Desktop\Project 1 (1)\10 Players Bio\New_Zealand_Cricketers.csv',
        r'C:\Users\Maroof\Desktop\Project 1 (1)\10 Players Bio\Pakistan_Cricketers.csv',
        r'C:\Users\Maroof\Desktop\Project 1 (1)\10 Players Bio\South_Africa_Cricketers.csv',
        r'C:\Users\Maroof\Desktop\Project 1 (1)\10 Players Bio\Sri_Lanka_Cricketers.csv'
    ]
